...
if ($Resposta == "0") {
    ...
    header('Location: ../login/atualizaSenha/');
} else {
}
...
<?php include '../../includes/imports/index.php'; ?>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active" id="liTela">Dashboard</li>
                        </ol>
                    </div>
                </div>
            </div>
        </div>
        <div class="content mt-3" id="Exibe">
